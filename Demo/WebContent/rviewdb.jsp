...
<body>
	<table border="2" align="center" height="70px" width="1000px" >
		<tr align="center" height="50px" width="50px" bgcolor="yellow">
			<td >No</td>
			<td>FirstName</td>
			<td>LastName</td>
			<td>Address</td>
		...
		<tr>
			...
			<td align="center" ><a href="rviewdb.jsp?did=<%=resultset.getString("id")%>"><button
						type="button" >Delete</button></a>&nbsp;&nbsp;&nbsp;<a href="rupdate.jsp?uid=<%=resultset.getString("id")%>"><button
